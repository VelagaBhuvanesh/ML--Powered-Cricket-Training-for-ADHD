...
Biomechanical Analysis: Tracks bat speed, wrist angle, backlift consistency, and follow-through

Cognitive Pattern Detection: Identifies ADHD-related movement patterns through 15+ mathematical features

ML-Powered Classification: Uses XGBoost trained on labeled ADHD/Control datasets

Wearable Hardware: ESP32-S3 + MPU-6050 integrated into a comfortable, washable sleeve

Mobile App Integration: Real-time feedback, analytics dashboard, and progress tracking

Patent-Ready Innovation: Novel combination of sports analytics and cognitive screening
